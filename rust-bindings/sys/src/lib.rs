...
impl ::std::fmt::Debug for OstreeRemote {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("OstreeRemote @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for OstreeRepoCheckoutAtOptions {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("OstreeRepoCheckoutAtOptions @ {self:p}"))
         ...
         .field("process_passthrough_whiteouts", &self.process_passthrough_whiteouts)
         .field("unused_bools", &self.unused_bools)
...
impl ::std::fmt::Debug for OstreeRepo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("OstreeRepo @ {self:p}"))
         .finish()
    }
}
...
extern "C" {
    ...
    pub fn ostree_kernel_args_contains(kargs: *mut OstreeKernelArgs, arg: *const c_char) -> gboolean;
    pub fn ostree_kernel_args_delete(kargs: *mut OstreeKernelArgs, arg: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    #[cfg(feature = "v2022_7")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v2022_7")))]
    pub fn ostree_kernel_args_delete_if_present(kargs: *mut OstreeKernelArgs, arg: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    #[cfg(feature = "v2019_3")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v2019_3")))]
    ...
    pub fn ostree_repo_checkout_composefs(self_: *mut OstreeRepo, options: *mut glib::GVariant, destination_dfd: c_int, destination_path: *const c_char, checksum: *const c_char, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn ostree_repo_commit_add_composefs_metadata(self_: *mut OstreeRepo, format_version: c_uint, dict: *mut glib::GVariantDict, repo_root: *mut OstreeRepoFile, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn ostree_repo_regenerate_metadata(self_: *mut OstreeRepo, additional_metadata: *mut glib::GVariant, options: *mut glib::GVariant, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    ...
    #[cfg(feature = "v2023_8")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v2023_8")))]
    pub fn ostree_sysroot_change_finalization(self_: *mut OstreeSysroot, deployment: *mut OstreeDeployment, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn ostree_sysroot_deployment_kexec_load(self_: *mut OstreeSysroot, deployment: *mut OstreeDeployment, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn ostree_sysroot_deployment_set_kargs_in_place(self_: *mut OstreeSysroot, deployment: *mut OstreeDeployment, kargs_str: *mut c_char, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    ...
    #[cfg(feature = "v2022_7")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v2022_7")))]
    pub fn ostree_sysroot_initialize_with_mount_namespace(self_: *mut OstreeSysroot, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    #[cfg(feature = "v2020_1")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v2020_1")))]
    ...
    pub fn ostree_sysroot_update_post_copy(self_: *mut OstreeSysroot, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn ostree_fs_get_all_xattrs(fd: c_int, cancellable: *mut gio::GCancellable, error: *mut *mut glib::GError) -> *mut glib::GVariant;
